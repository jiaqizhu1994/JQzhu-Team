...
export function ActivityDetailClient({
  ...
  const item = Number.isInteger(activityIndex)
  ...
  if (!isReady) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
        <p className="text-sm font-semibold text-slate-500">正在加载活动内容...</p>
      </main>
    );
  }
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
        <div className="text-center">
          ...
          <Link href="/#activities" className="secondary-button mt-6">
        ...
        <div className="mx-auto flex h-20 max-w-6xl items-center px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span>
              ...
              <span className="block text-xs text-slate-500">Activity Detail</span>
            </span>
          </Link>
        </div>
      </header>
        ...
        {images.length ? (
          <section className="mt-14 border-t border-slate-200 pt-10">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-slate-950">相关图片</h2>
